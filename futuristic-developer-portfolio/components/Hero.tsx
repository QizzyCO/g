    ...
    >
      <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-12 w-full mb-16">
        <div className="flex-1 text-left">
          ...
          >
            <span className="text-gray-500 text-[10px] mono uppercase tracking-[0.3em]">Sync Social:</span>
            <div className="flex gap-4">
              <a href="#" className="p-2 bg-white/5 hover:bg-blue-500/20 border border-white/10 hover:border-blue-500/50 rounded-xl transition-all text-gray-400 hover:text-blue-400"><Github size={20} /></a>
              <a href="#" className="p-2 bg-white/5 hover:bg-blue-500/20 border border-white/10 hover:border-blue-500/50 rounded-xl transition-all text-gray-400 hover:text-blue-400"><Linkedin size={20} /></a>
              <a href="#" className="p-2 bg-white/5 hover:bg-blue-500/20 border border-white/10 hover:border-blue-500/50 rounded-xl transition-all text-gray-400 hover:text-blue-400"><Twitter size={20} /></a>
              <a href="https://www.instagram.com/qizzy_neon._/" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/5 hover:bg-blue-500/20 border border-white/10 hover:border-blue-500/50 rounded-xl transition-all text-gray-400 hover:text-blue-400"><Instagram size={20} /></a>
            </div>
          </motion.div>
        </div>
